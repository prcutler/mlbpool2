...
def log_package_versions():
    ...
    requires = [
        ...
        {"name": "python-dateutil", "version": "2.6.1"},
        {"name": "pytz", "version": "2018.3"},
        {"name": "pytzdata", "version": "2018.3"},
        {"name": "repoze.lru", "version": "0.7"},
        {"name": "requests", "version": "2.18.4"},
        {"name": "rollbar", "version": "0.13.17"},
