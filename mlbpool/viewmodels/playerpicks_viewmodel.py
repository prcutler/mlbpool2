...
class PlayerPicksViewModel(ViewModelBase):
    def __init__(self):
        ...
        self.al_central_second = None
        self.al_central_last = None
        self.al_west_winner_pick = None
        self.al_west_second = None
        self.al_west_last = None
        self.nl_east_winner_pick = None
        self.nl_east_second = None
        self.nl_east_last = None
        self.nl_central_winner_pick = None
        self.nl_central_second = None
        self.nl_central_last = None
        self.nl_west_winner_pick = None
        self.nl_west_second = None
        self.nl_west_last = None
    ...
    def from_dict(self, data_dict):
        ...
        self.al_east_second = data_dict.get('al_east_second_pick')
        self.al_east_last = data_dict.get('al_east_last_pick')
        self.al_central_winner_pick = data_dict.get('al_central_winner_pick')
        self.al_central_second = data_dict.get('al_central_second_pick')
        self.al_central_last = data_dict.get('al_central_last_pick')
        self.al_west_winner_pick = data_dict.get('al_west_winner_pick')
        self.al_west_second = data_dict.get('al_west_second_pick')
        self.al_west_last = data_dict.get('al_west_last_pick')
        self.nl_east_winner_pick = data_dict.get('nl_east_winner_pick')
        self.nl_east_second = data_dict.get('nl_east_second_pick')
        self.nl_east_last = data_dict.get('nl_east_last_pick')
        self.nl_central_winner_pick = data_dict.get('nl_central_winner_pick')
        self.nl_central_second = data_dict.get('nl_central_second_pick')
        self.nl_central_last = data_dict.get('nl_central_last_pick')
        self.nl_west_winner_pick = data_dict.get('nl_west_winner_pick')
        self.nl_west_second = data_dict.get('nl_west_second_pick')
        self.nl_west_last = data_dict.get('nl_west_last_pick')
