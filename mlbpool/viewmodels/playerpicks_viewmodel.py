...
class PlayerPicksViewModel(ViewModelBase):
    ...
    def from_dict(self, data_dict):
        ...
        self.al_central_second = data_dict.get('al_central_second')
        self.al_central_last = data_dict.get('al_central_last')
        self.al_west_winner_pick = data_dict.get('al_west_winner_pick')
        self.al_west_second = data_dict.get('al_west_second')
        self.al_west_last = data_dict.get('al_west_last')
        self.nl_east_winner_pick = data_dict.get('nl_east_winner_pick')
        self.nl_east_second = data_dict.get('nl_east_second')
        self.nl_east_last = data_dict.get('nl_east_last')
        self.nl_central_winner_pick = data_dict.get('nl_central_winner_pick')
        self.nl_central_second = data_dict.get('nl_central_second')
        self.nl_central_last = data_dict.get('nl_central_last')
        self.nl_west_winner_pick = data_dict.get('nl_west_winner_pick')
        self.nl_west_second = data_dict.get('nl_west_second')
        self.nl_west_last = data_dict.get('nl_west_last')
