...
from mlbpool.viewmodels.standings_season_points_viewmodel import (
    StandingsPointsViewModel,
)
...
class StandingsController(BaseController):
    ...
    def season(self):
        ...
        date_query = (
            session.query(WeeklyPlayerResults.update_date)
            .order_by(WeeklyPlayerResults.update_date.desc())
            .first()
        )
