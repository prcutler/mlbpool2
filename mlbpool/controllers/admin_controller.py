...
class AdminController(BaseController):
    ...
    def new_season_post(self):
        ...
        NewSeasonService.create_season(
            vm.new_season_input, vm.season_all_star_game_date_input
        )
    ...
    @pyramid_handlers.action(
        renderer="templates/admin/add_mlbplayers.pt",
        request_method="GET",
        name="add_mlbplayers",
    )
    ...
    def add_mlb_players_post(self):
        ...
        ActivePlayersService.add_active_mlbplayers(
    ...
    @pyramid_handlers.action(
        renderer="templates/admin/pitcher-trades.pt",
        request_method="GET",
        name="pitcher-trades",
    )
    ...
    @pyramid_handlers.action(
        renderer="templates/admin/pitcher-trades",
        request_method="POST",
        name="pitcher-trades",
    )
    def pitcher_trades_post(self):
        ...
        TradeService.get_pitcher_trade(
            vm.player_id, vm.team_id, vm.games, vm.p_wins, vm.era, vm.er, vm.ip
        )
    ...
    @pyramid_handlers.action(
        renderer="templates/admin/hitter-trades.pt",
        request_method="GET",
        name="hitter-trades",
    )
    ...
    @pyramid_handlers.action(
        renderer="templates/admin/hitter-trades",
        request_method="POST",
        name="hitter-trades",
    )
    ...
    @pyramid_handlers.action(
        renderer="templates/admin/update_mlbplayers.pt",
        request_method="GET",
