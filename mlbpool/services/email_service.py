...
from mlbpool.email.template_parser import EmailTemplateParser
...
class EmailService:
    ...
    __from_address = 'MLBPool <pcutler@nflpool.xyz>'
    ...
    def send_password_reset_email(cls, email, reset_id):
        ...
        EmailService.send_email(email, 'Reset your password at MLBPool', html_body)
