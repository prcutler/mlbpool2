...
class PlayerPicksService:
    ...
    def get_player_picks(
        cls,
        al_east_winner_pick: int,
        al_east_second: int,
        al_east_last: int,
        al_central_winner_pick: int,
        al_central_second: int,
        al_central_last: int,
        al_west_winner_pick: int,
        al_west_second: int,
        al_west_last: int,
        nl_east_winner_pick: int,
        nl_east_second: int,
        nl_east_last: int,
        nl_central_winner_pick: int,
        nl_central_second: int,
        nl_central_last: int,
        nl_west_winner_pick: int,
        nl_west_second: int,
        nl_west_last: int,
        al_hr_pick: int,
        nl_hr_pick: int,
        ...
        al_wildcard2_pick: int,
        nl_wildcard1_pick: int,
        nl_wildcard2_pick: int,
        al_wins_pick: int,
        nl_wins_pick: int,
        al_losses_pick: int,
        nl_losses_pick: int,
        ...
        al_central_winner_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            league_id=0,
        ...
        nl_central_winner_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            league_id=1,
        ...
        al_hr_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            player_id=al_hr_pick,
            pick_type=4,
            league_id=0,
        ...
        al_ba_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            player_id=al_ba_pick,
            pick_type=5,
            league_id=0,
        ...
        al_rbi_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            player_id=al_rbi_pick,
            pick_type=6,
            league_id=0,
            original_pick=al_rbi_pick,
        )
        ...
        al_era_db = PlayerPicks(
            ...
            season=season,
            date_submitted=now_time,
            player_id=al_era_pick,
            pick_type=8,
            league_id=0,
            original_pick=al_era_pick,
        )
        session.add(al_era_db)

        # Add National League Player Picks

        nl_hr_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            player_id=nl_hr_pick,
            pick_type=4,
            league_id=1,
            original_pick=nl_hr_pick,
        )
        session.add(nl_hr_db)

        nl_ba_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            player_id=nl_ba_pick,
            pick_type=5,
            league_id=1,
            original_pick=nl_ba_pick,
        )
        session.add(nl_ba_db)

        nl_rbi_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            player_id=nl_rbi_pick,
            pick_type=6,
            league_id=1,
            original_pick=nl_rbi_pick,
        )
        ...
        nl_era_db = PlayerPicks(
            ...
            season=season,
            date_submitted=now_time,
            player_id=nl_era_pick,
            pick_type=8,
            league_id=1,
            original_pick=nl_era_pick,
        )
        session.add(nl_era_db)

        # Add the wildcard picks
        al_wildcard1_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            team_id=al_wildcard1_pick,
            pick_type=9,
            league_id=0,
            original_pick=al_wildcard1_pick,
            rank=1,
        )
        session.add(al_wildcard1_db)

        al_wildcard2_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            team_id=al_wildcard2_pick,
            pick_type=9,
            league_id=0,
            original_pick=al_wildcard2_pick,
            rank=2,
        )
        session.add(al_wildcard2_db)

        nl_wildcard1_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            team_id=nl_wildcard1_pick,
            pick_type=9,
            league_id=1,
            original_pick=nl_wildcard1_pick,
            rank=1,
        )
        session.add(nl_wildcard1_db)

        nl_wildcard2_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            team_id=nl_wildcard2_pick,
            pick_type=9,
            league_id=1,
            original_pick=nl_wildcard2_pick,
            rank=2,
        )
        session.add(nl_wildcard2_db)

        # Add the Most Wins
        al_wins_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            team_id=al_wins_pick,
            pick_type=3,
            league_id=0,
            original_pick=al_wins_pick,
        )
        session.add(al_wins_db)

        nl_wins_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            team_id=nl_wins_pick,
            pick_type=3,
            league_id=1,
            original_pick=nl_wins_pick,
        )
        session.add(nl_wins_db)

        # Add the Most Losses
        al_losses_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            team_id=al_losses_pick,
            pick_type=2,
            league_id=0,
            original_pick=al_losses_pick,
        )
        session.add(al_losses_db)

        nl_losses_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            team_id=nl_losses_pick,
            pick_type=2,
            league_id=1,
            original_pick=nl_losses_pick,
        )
        session.add(nl_losses_db)

        # Add the tiebreaker
        twins_wins_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=now_time,
            twins_wins=twins_wins_pick,
            pick_type=10,
            original_pick=twins_wins_pick,
        )
    ...
    def change_player_picks(
        cls,
        al_east_winner_pick: int,
        al_east_second_pick: int,
        al_east_last_pick: int,
        al_central_winner_pick: int,
        al_central_second_pick: int,
        al_central_last_pick: int,
        al_west_winner_pick: int,
        al_west_second_pick: int,
        al_west_last_pick: int,
        nl_east_winner_pick: int,
        nl_east_second_pick: int,
        nl_east_last_pick: int,
        nl_central_winner_pick: int,
        nl_central_second_pick: int,
        nl_central_last_pick: int,
        nl_west_winner_pick: int,
        nl_west_second_pick: int,
        nl_west_last_pick: int,
        al_hr_pick: int,
        nl_hr_pick: int,
        al_rbi_pick: int,
        nl_rbi_pick: int,
        ...
        if GameDayService.season_opener_date() > now_time:
            ...
            if al_east_winner_pick != session.query(PlayerPicks).filter(
            ...
            if al_east_second_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
            ...
            if al_east_last_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
            ...
            if al_central_winner_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
            ...
            if al_central_second_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
                ...
                session.query(PlayerPicks).filter(
                    ...
                    {
                        "team_id": al_central_second_pick,
                        "date_submitted": now_time,
            ...
            if al_central_last_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
            ...
            if al_west_winner_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
            ...
            if al_west_second_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
                ...
                session.query(PlayerPicks).filter(
                    ...
                    {
                        "team_id": al_west_second_pick,
                        "date_submitted": now_time,
                        "original_pick": al_west_second_pick,
                    }
                )

            if al_west_last_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
                ...
                session.query(PlayerPicks).filter(
                    ...
                    {
                        "team_id": al_west_last_pick,
                        "date_submitted": now_time,
                        "original_pick": al_west_last_pick,
                    }
                )

            # Update the NL East Winner Pick - check to see if it has been changed
            if nl_east_winner_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
            ...
            if nl_east_second_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
            ...
            if nl_east_last_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
                ...
                session.query(PlayerPicks).filter(
                    ...
                    {
                        "team_id": nl_east_last_pick,
                        "date_submitted": now_time,
                        "original_pick": nl_east_last_pick,
                    }
                )

            # Update the NL Central Winner Pick - check to see if it has been changed
            if nl_central_winner_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
            ...
            if nl_central_second_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
                ...
                session.query(PlayerPicks).filter(
                    ...
                    {
                        "team_id": nl_central_second_pick,
                        "date_submitted": now_time,
                        "original_pick": nl_central_second_pick,
                    }
                )

            if nl_central_last_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
            ...
            if nl_west_winner_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
            ...
            if nl_west_second_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
            ...
            if nl_west_last_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 1
            ).filter(
                ...
                session.query(PlayerPicks).filter(
                    ...
                    {
                        "team_id": nl_west_last_pick,
                        "date_submitted": now_time,
                        "original_pick": nl_west_last_pick,
                    }
                )

            # Update Pick Type 2 - Team Losses
            if al_losses_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
            ...
            if nl_losses_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 2
            ).filter(
            ...
            if al_wins_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
            ...
            if nl_wins_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 3
            ).filter(
            ...
            if al_hr_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
            ...
            if nl_hr_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 4
            ).filter(
            ...
            if al_ba_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
            ...
            if nl_ba_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 5
            ).filter(
            ...
            if al_rbi_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
            ...
            if nl_rbi_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 6
            ).filter(
            ...
            if al_era_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
            ...
            if nl_era_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 8
            ).filter(
            ...
            if al_wildcard1_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
            ...
            if al_wildcard2_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 9
            ).filter(
            ...
            if nl_wildcard1_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 9
            ).filter(
            ...
            if nl_wildcard2_pick != session.query(PlayerPicks).filter(
                PlayerPicks.user_id == user_id
            ).filter(PlayerPicks.season == season).filter(
                PlayerPicks.pick_type == 9
            ).filter(
...
class DisplayPlayerPicks:
    ...
    def display_picks(user_id):
        ...
        user_query = (
            ...
            .join(TeamInfo, PlayerPicks.team_id == TeamInfo.team_id)
            .filter(PlayerPicks.user_id == user_id)
            .filter(PlayerPicks.season == season)
            .all()
        )
