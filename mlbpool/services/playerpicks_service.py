...
class PlayerPicksService:
    ...
    def get_player_picks(cls, al_east_winner_pick: int, al_east_second: int, al_east_last: int,
        ...
        al_east_winner_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=0,
                                        division_id=1, rank=1, team_id=al_east_winner_pick, pick_type=1,
                                        original_pick=al_east_winner_pick)
        session.add(al_east_winner_db)
        al_east_second_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=0,
                                        division_id=1, rank=2, team_id=al_east_second, pick_type=1,
                                        original_pick=al_east_second)
        session.add(al_east_second_db)

        al_east_last_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=0,
                                      division_id=1, rank=5, team_id=al_east_last, pick_type=1,
                                      original_pick=al_east_last)

        session.add(al_east_last_db)

        al_central_winner_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=0,
                                           division_id=2, rank=1, team_id=al_central_winner_pick, pick_type=1,
                                           original_pick=al_central_winner_pick)
        session.add(al_central_winner_db)

        al_central_second_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=0,
                                           division_id=2, rank=2, team_id=al_central_second, pick_type=1,
                                           original_pick=al_central_second)
        session.add(al_central_second_db)

        al_central_last_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=0,
                                         division_id=2, rank=5, team_id=al_central_last, pick_type=1,
                                         original_pick=al_central_last)

        session.add(al_central_last_db)

        al_west_winner_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=0,
                                        division_id=3, rank=1, team_id=al_west_winner_pick, pick_type=1,
                                        original_pick=al_west_winner_pick)
        session.add(al_west_winner_db)
        al_west_second_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=0,
                                        division_id=3, rank=2, team_id=al_west_second, pick_type=1,
                                        original_pick=al_west_second)
        session.add(al_west_second_db)

        al_west_last_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=0,
                                      division_id=3, rank=5, team_id=al_west_last, pick_type=1,
                                      original_pick=al_west_last)

        session.add(al_west_last_db)

        # Add National League team picks
        nl_east_winner_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=1,
                                        division_id=1, rank=1, team_id=nl_east_winner_pick, pick_type=1,
                                        original_pick=nl_east_winner_pick)
        session.add(nl_east_winner_db)

        nl_east_second_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=1,
                                        division_id=1, rank=2, team_id=nl_east_second, pick_type=1,
                                        original_pick=nl_east_second)
        session.add(nl_east_second_db)

        nl_east_last_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=1,
                                      division_id=1, rank=5, team_id=nl_east_last, pick_type=1,
                                      original_pick=nl_east_last)

        session.add(nl_east_last_db)

        nl_central_winner_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=1,
                                           division_id=2, rank=1, team_id=nl_central_winner_pick, pick_type=1,
                                           original_pick=nl_central_winner_pick)
        session.add(nl_central_winner_db)

        nl_central_second_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=1,
                                           division_id=2, rank=2, team_id=nl_central_second, pick_type=1,
                                           original_pick=nl_central_second)
        session.add(nl_central_second_db)

        nl_central_last_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=1,
                                         division_id=2, rank=5, team_id=nl_central_last, pick_type=1,
                                         original_pick=nl_central_last)

        session.add(nl_central_last_db)

        nl_west_winner_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=1,
                                        division_id=3, rank=1, team_id=nl_west_winner_pick, pick_type=1,
                                        original_pick=nl_west_winner_pick)
        session.add(nl_west_winner_db)

        nl_west_second_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=1,
                                        division_id=3, rank=2, team_id=nl_west_second, pick_type=1,
                                        original_pick=nl_west_second)
        session.add(nl_west_second_db)

        nl_west_last_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, league_id=1,
                                      division_id=3, rank=5, team_id=nl_west_last, pick_type=1,
        ...
        al_hr_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, player_id=al_hr_pick,
                               pick_type=4, league_id=0,
                               original_pick=al_hr_pick)
        session.add(al_hr_db)

        al_ba_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, player_id=al_ba_pick,
                               pick_type=5, league_id=0,
                               original_pick=al_ba_pick)
        session.add(al_ba_db)

        al_rbi_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, player_id=al_rbi_pick,
                                pick_type=6, league_id=0, original_pick=al_rbi_pick)
        session.add(al_rbi_db)

        al_p_wins_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, player_id=al_p_wins_pick,
                                   pick_type=7, league_id=0, original_pick=al_p_wins_pick)
        session.add(al_p_wins_db)

        al_era_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, player_id=al_era_pick,
                                pick_type=8, league_id=0, original_pick=al_era_pick)
        session.add(al_era_db)

        # Add National League Player Picks

        nl_hr_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, player_id=nl_hr_pick,
                               pick_type=4, league_id=1, original_pick=nl_hr_pick)
        session.add(nl_hr_db)

        nl_ba_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, player_id=nl_ba_pick,
                               pick_type=5, league_id=1, original_pick=nl_ba_pick)
        session.add(nl_ba_db)

        nl_rbi_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, player_id=nl_rbi_pick,
                                pick_type=6, league_id=1, original_pick=nl_rbi_pick)
        session.add(nl_rbi_db)

        nl_p_wins_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, player_id=nl_p_wins_pick,
                                   pick_type=7, league_id=1, original_pick=nl_p_wins_pick)
        session.add(nl_p_wins_db)

        nl_era_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, player_id=nl_era_pick,
                                pick_type=8, league_id=1, original_pick=nl_era_pick)
        session.add(nl_era_db)

        # Add the wildcard picks
        al_wildcard1_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time,
                                      team_id=al_wildcard1_pick, pick_type=9, league_id=0,
                                      original_pick=al_wildcard1_pick, rank=1)
        session.add(al_wildcard1_db)

        al_wildcard2_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, team_id=al_wildcard2_pick,
                                      pick_type=9, league_id=0, original_pick=al_wildcard2_pick, rank=2)
        session.add(al_wildcard2_db)

        nl_wildcard1_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, team_id=nl_wildcard1_pick,
                                      pick_type=9, league_id=1, original_pick=nl_wildcard1_pick, rank=1)
        session.add(nl_wildcard1_db)

        nl_wildcard2_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, team_id=nl_wildcard2_pick,
                                      pick_type=9, league_id=1, original_pick=nl_wildcard2_pick, rank=2)
        session.add(nl_wildcard2_db)

        # Add the Most Wins 
        al_wins_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, team_id=al_wins_pick,
                                 pick_type=3, league_id=0, original_pick=al_wins_pick)
        session.add(al_wins_db)

        nl_wins_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, team_id=nl_wins_pick,
                                 pick_type=3, league_id=1, original_pick=nl_wins_pick)
        session.add(nl_wins_db)

        # Add the Most Losses
        al_losses_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, team_id=al_losses_pick,
                                pick_type=2, league_id=0, original_pick=al_losses_pick)
        session.add(al_losses_db)

        nl_losses_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, team_id=nl_losses_pick,
                                pick_type=2, league_id=1, original_pick=nl_losses_pick)
        session.add(nl_losses_db)

        # Add the tiebreaker
        twins_wins_db = PlayerPicks(user_id=user_id, season=season, date_submitted=now_time, twins_wins=twins_wins_pick,
        ...
        if GameDayService.season_opener_date() > now_time:
            ...
            if al_east_second_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.division_id == 1) \
                    .update({"team_id": al_east_second_pick, "date_submitted": now_time,
            ...
            if al_east_last_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.division_id == 1) \
                    .update({"team_id": al_east_last_pick, "date_submitted": now_time,
                             "original_pick": al_east_last_pick})
            ...
            if al_central_winner_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.division_id == 2) \
                    .update({"team_id": al_central_winner_pick, "date_submitted": now_time,
                             "original_pick": al_central_winner_pick})
            ...
            if al_central_second_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.rank == 2).filter(PlayerPicks.league_id == 0)\
                    .filter(PlayerPicks.division_id == 2) \
                    .update({"team_id": al_central_second_pick, "date_submitted": now_time,
            ...
            if al_central_last_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.division_id == 2) \
                    .update(
                    {"team_id": al_central_last_pick, "date_submitted": now_time,
                     "original_pick": al_central_last_pick})
            ...
            if al_west_winner_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.rank == 1).filter(PlayerPicks.league_id == 0)\
                    .filter(PlayerPicks.division_id == 3) \
                    .update({"team_id": al_west_winner_pick, "date_submitted": now_time,
                             "original_pick": al_west_winner_pick})
            ...
            if al_west_second_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id).filter(
                    ...
                    filter(PlayerPicks.rank == 2).filter(PlayerPicks.league_id == 0)\
                    .filter(PlayerPicks.division_id == 3) \
                    .update({"team_id": al_west_second_pick, "date_submitted": now_time,
            ...
            if al_west_last_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.division_id == 3) \
                    .update(
                    {"team_id": al_west_last_pick, "date_submitted": now_time, "original_pick": al_west_last_pick})
            ...
            if nl_east_winner_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.division_id == 1) \
                    .update({"team_id": nl_east_winner_pick, "date_submitted": now_time,
                             "original_pick": nl_east_winner_pick})
            ...
            if nl_east_second_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.division_id == 1) \
                    .update({"team_id": nl_east_second_pick, "date_submitted": now_time,
            ...
            if nl_east_last_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.division_id == 1) \
                    .update(
                    {"team_id": nl_east_last_pick, "date_submitted": now_time, "original_pick": nl_east_last_pick})
            ...
            if nl_central_winner_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.rank == 1).filter(PlayerPicks.league_id == 1)\
                    .filter(PlayerPicks.division_id == 2) \
                    .update({"team_id": nl_central_winner_pick, "date_submitted": now_time,
                             "original_pick": nl_central_winner_pick})
            ...
            if nl_central_second_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.rank == 2).filter(PlayerPicks.league_id == 1)\
                    .filter(PlayerPicks.division_id == 2) \
                    .update({"team_id": nl_central_second_pick, "date_submitted": now_time,
            ...
            if nl_central_last_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.division_id == 2) \
                    .update(
                    {"team_id": nl_central_last_pick, "date_submitted": now_time,
                     "original_pick": nl_central_last_pick})
            ...
            if nl_west_winner_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 1)\
                    .filter(PlayerPicks.division_id == 3) \
                    .update({"team_id": nl_west_winner_pick, "date_submitted": now_time,
                             "original_pick": nl_west_winner_pick})
            ...
            if nl_west_second_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 1)\
                    .filter(PlayerPicks.division_id == 3) \
                    .update({"team_id": nl_west_second_pick, "date_submitted": now_time,
            ...
            if nl_west_last_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.division_id == 3) \
                    .update(
                    {"team_id": nl_west_last_pick, "date_submitted": now_time, "original_pick": nl_west_last_pick})
            ...
            if al_losses_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id)\
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id)\
                    .filter(PlayerPicks.pick_type == 2)\
                    .filter(PlayerPicks.league_id == 0)\
                    .update({"team_id": al_losses_pick, "date_submitted": now_time, "original_pick": al_losses_pick})
            ...
            if nl_losses_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id)\
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id)\
                    .filter(PlayerPicks.pick_type == 2)\
                    .filter(PlayerPicks.league_id == 1)\
                    .update({"team_id": nl_losses_pick, "date_submitted": now_time, "original_pick": nl_losses_pick})
            ...
            if al_wins_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 0) \
                    .update(
                    {"team_id": al_wins_pick, "date_submitted": now_time, "original_pick": al_wins_pick})
            ...
            if nl_wins_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 1) \
                    .update(
                    {"team_id": nl_wins_pick, "date_submitted": now_time, "original_pick": nl_wins_pick})
            ...
            if al_hr_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 0) \
                    .update(
                    {"player_id": al_hr_pick, "date_submitted": now_time, "original_pick": al_hr_pick})
            ...
            if nl_hr_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 1) \
                    .update(
                    {"player_id": nl_hr_pick, "date_submitted": now_time, "original_pick": nl_hr_pick})
            ...
            if al_ba_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 0) \
                    .update(
                    {"player_id": al_ba_pick, "date_submitted": now_time, "original_pick": al_ba_pick})
            ...
            if nl_ba_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 1) \
                    .update(
                    {"player_id": nl_ba_pick, "date_submitted": now_time, "original_pick": nl_ba_pick})
            ...
            if al_rbi_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 0) \
                    .update(
                    {"player_id": al_rbi_pick, "date_submitted": now_time, "original_pick": al_rbi_pick})
            ...
            if nl_rbi_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 1) \
                    .update(
                    {"player_id": nl_rbi_pick, "date_submitted": now_time, "original_pick": nl_rbi_pick})
            ...
            if al_p_wins_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 0) \
                    .update(
                    {"player_id": al_p_wins_pick, "date_submitted": now_time, "original_pick": al_p_wins_pick})
            ...
            if nl_p_wins_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 1) \
                    .update(
                    {"player_id": nl_p_wins_pick, "date_submitted": now_time, "original_pick": nl_p_wins_pick})
            ...
            if al_era_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 0) \
                    .update(
                    {"player_id": al_era_pick, "date_submitted": now_time, "original_pick": al_era_pick})
            ...
            if nl_era_pick != session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                ...
                session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                    ...
                    .filter(PlayerPicks.league_id == 1) \
                    .update(
                    {"player_id": nl_era_pick, "date_submitted": now_time, "original_pick": nl_era_pick})
            ...
            for pick in session.query(PlayerPicks.team_id).filter(PlayerPicks.user_id == user_id) \
                ...
                if pick != int(al_east_second_pick):
                    session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                        ...
                        .filter(PlayerPicks.rank == 2).filter(PlayerPicks.league_id == 0) \
                        .filter(PlayerPicks.division_id == 1) \
                        .update({"team_id": al_east_second_pick, "date_submitted": now_time, "changed": 1,
                                 "multiplier": 1})
            ...
            for pick in session.query(PlayerPicks.team_id).filter(PlayerPicks.user_id == user_id) \
                ...
                if pick != int(al_east_last_pick):
                    session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                        ...
                        .filter(PlayerPicks.rank == 5).filter(PlayerPicks.league_id == 0) \
                        .filter(PlayerPicks.division_id == 1) \
                        .update({"team_id": al_east_last_pick, "date_submitted": now_time, "changed": 1,
                                 "multiplier": 1})
            ...
            for pick in session.query(PlayerPicks.team_id).filter(PlayerPicks.user_id == user_id) \
                ...
                if pick != int(al_central_second_pick):
                    session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                        ...
                        .filter(PlayerPicks.rank == 2).filter(PlayerPicks.league_id == 0) \
                        .filter(PlayerPicks.division_id == 2) \
                        .update({"team_id": al_central_second_pick, "date_submitted": now_time, "changed": 1,
                                 "multiplier": 1})
            ...
            for pick in session.query(PlayerPicks.team_id).filter(PlayerPicks.user_id == user_id) \
                ...
                if pick != int(al_central_last_pick):
                    session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                        ...
                        .filter(PlayerPicks.rank == 5).filter(PlayerPicks.league_id == 0) \
                        .filter(PlayerPicks.division_id == 2) \
                        .update({"team_id": al_central_last_pick, "date_submitted": now_time, "changed": 1,
                                 "multiplier": 1})
            ...
            for pick in session.query(PlayerPicks.team_id).filter(PlayerPicks.user_id == user_id) \
                ...
                if pick != int(nl_east_second_pick):
                    session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                        ...
                        .filter(PlayerPicks.rank == 2).filter(PlayerPicks.league_id == 1) \
                        .filter(PlayerPicks.division_id == 1) \
                        .update({"team_id": nl_east_second_pick, "date_submitted": now_time, "changed": 1,
                                 "multiplier": 1})
            ...
            for pick in session.query(PlayerPicks.team_id).filter(PlayerPicks.user_id == user_id) \
                ...
                if pick != int(nl_east_last_pick):
                    session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                        ...
                        .filter(PlayerPicks.rank == 5).filter(PlayerPicks.league_id == 1) \
                        .filter(PlayerPicks.division_id == 1) \
                        .update({"team_id": nl_east_last_pick, "date_submitted": now_time, "changed": 1,
                                 "multiplier": 1})
            ...
            for pick in session.query(PlayerPicks.team_id).filter(PlayerPicks.user_id == user_id) \
                ...
                if pick != int(nl_central_second_pick):
                    session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                        ...
                        .filter(PlayerPicks.rank == 2).filter(PlayerPicks.league_id == 1) \
                        .filter(PlayerPicks.division_id == 2) \
                        .update({"team_id": nl_central_second_pick, "date_submitted": now_time, "changed": 1,
                                 "multiplier": 1})
            ...
            for pick in session.query(PlayerPicks.team_id).filter(PlayerPicks.user_id == user_id) \
                ...
                if pick != int(nl_central_last_pick):
                    session.query(PlayerPicks).filter(PlayerPicks.user_id == user_id) \
                        ...
                        .filter(PlayerPicks.rank == 5).filter(PlayerPicks.league_id == 1) \
                        .filter(PlayerPicks.division_id == 2) \
                        .update({"team_id": nl_central_last_pick, "date_submitted": now_time, "changed": 1,
                                 "multiplier": 1})
